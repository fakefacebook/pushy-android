 ...
 * MenuTintHelper.on(menu).setMenuItemIconColor(color).setMenuItemIconAlpha(alpha).apply(this);
 * ...
 * }
 * </pre>
 */
...
public class MenuTintHelper {
    ...
    private static final String TAG = "MenuTintHelper";
    ...
    private MenuTintHelper(Builder builder) {
        menu = builder.menu;
    ...
    public static void colorIcons(Activity activity, Menu menu, int color) {
        MenuTintHelper.on(menu).setMenuItemIconColor(color).apply(activity);
    }
    ...
    public static class NativeActionExpandListener implements OnActionExpandListener {
        ...
        public NativeActionExpandListener(MenuTintHelper menuTintHelper) {
    ...
    public static final class Builder {
         ...
         * <p>Note: This is targeted for the native ActionBar/Toolbar, not AppCompat.</p>
         */
        public MenuTintHelper apply(Activity activity) {
            MenuTintHelper theme = new MenuTintHelper(this);
            theme.apply(activity);
            return theme;
        }

        /**
         * <p>Creates a {@link MenuTintHelper} with the arguments supplied to this builder.</p>
         * <p/>
         * <p>It does not apply the theme. Call {@link MenuTintHelper#apply(Activity)} to do so.</p>
         *
         * @see #apply(Activity)
         */
        public MenuTintHelper create() {
            return new MenuTintHelper(this);
        }
